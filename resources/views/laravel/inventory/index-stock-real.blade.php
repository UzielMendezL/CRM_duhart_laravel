...
@section('content')
    <nav class="navbar navbar-main navbar-expand-lg  px-0 mx-4 shadow-none border-radius-xl z-index-sticky " id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            @include('layouts.navbars.auth.topnav', ['title' => 'Inventarios','secondTitle' => 'Stock Real'])
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header pb-0">
                        <div class="d-lg-flex">
                            <div>
                                <h5 class="mb-0">Stock Real</h5>
                                <p class="text-sm mb-0">
                                   materiales existentes de stock mayor a 0
                                </p>
                            </div>
                            ...
                            <table class="table table-flush" id="products-list">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-sm">
                                            <span data-bs-placement="top" data-bs-original-title="Ver material"  data-bs-toggle="tooltip" >
