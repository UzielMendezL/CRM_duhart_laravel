...
@section('content')
    <nav class="navbar navbar-main navbar-expand-lg  px-0 mx-4 shadow-none border-radius-xl z-index-sticky " id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            @include('layouts.navbars.auth.topnav', ['title' => 'Colaboradores','secondTitle' => 'Lista de empleados'])
                            ...
                            <div class="ms-auto my-auto mt-lg-0 mt-4">
                                <div class="ms-auto my-auto">
                                    <a href="./inventory/new-material" class="btn bg-gradient-primary btn-sm mb-0"
                                        target="_blank">+&nbsp; Nuevo empleado</a>
                                    ...
                                    <tr>
                                        <td class="text-sm font-weight-normal">
                                            <div class="d-flex my-2 text-xs">
                                                ...
                                                @isset($item->photo)
                                                    <img style  = "min-width:100; max-width:100px;"  loading="lazy" src="./assets/img/employees/photo/{{$item->photo}}" alt="" class="border-radius-lg shadow-sm height-100 w-auto">
                                                @else
                                        ...
                                        <td class="text-sm">
                                            <span data-bs-placement="top" data-bs-original-title="Editar empleado"  data-bs-toggle="tooltip" >
                                                <a data-bs-placement="bottom" class="mx-3" onclick="return getInfoMaterial({{$item->idMaterial}});" data-bs-toggle="modal"
                                                    data-bs-target="#editModal">
                                                    <i class="fas fa-eye text-secondary"></i>
                                                </a>
                                            </span>
                                            <span data-bs-placement="top" data-bs-original-title="Eliminar empleado"  data-bs-toggle="tooltip" >
                                            ...
                                            <div class="modal fade" id="deleteModal-{{ $item->idMaterial }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    @method('delete')
                                                    <div class="modal-body">
                                                        <span>¿Deseas remover este colaborador?</span>
                                                    </div>
                                                    <div class="modal-footer">
