...
@section('content')
    <nav class="navbar navbar-main navbar-expand-lg  px-0 mx-4 shadow-none border-radius-xl z-index-sticky " id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            @include('layouts.navbars.auth.topnav', ['title' => 'New Item'])
            ...
            <div class="col-lg-9 col-12 mx-auto">
                <div class="card card-body mt-4">
                    ...
                    <form method="POST" action="{{ route('item-new.store') }}" enctype="multipart/form-data"
                        ...
                        <div>
                            <textarea name="excerpt" rows="2" class="w-100 form-control">{{ old('excerpt') }}</textarea>
                            @error('excerpt')
                                <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                            @enderror
                        </div>
                            ...
                            <select class="form-control" name="choices-category" id="choices-category">
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}"
                                        {{ old('choices-category') == $category->id ? 'selected' : '' }}>
                        ...
                        <div class="row mt-4">
                            <div class="col-6">
                                ...
                                <input class="form-control datetimepicker" type="text" name="date"
                                    placeholder="Please select start date" data-input value="{{ old('date') }}">
                            </div>
                        </div>
