...
@section('content')
    <nav class="navbar navbar-main navbar-expand-lg  px-0 mx-4 shadow-none border-radius-xl z-index-sticky " id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            @include('layouts.navbars.auth.topnav', ['title' => 'New Tag'])
        ...
        <div class="row mb-5">
            <div class="col-lg-9 col-12 mx-auto">
                <div class="card card-body mt-4">
                    ...
                    <form method="POST" action="{{ route('tag-new.store') }}">
                        @csrf
                        ...
                        <input type="color" name="color" id="input-name" class="form-control " placeholder="Color" value=""
