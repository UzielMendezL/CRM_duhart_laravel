            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-7 mx-auto text-center">
                        <h1 class="display-1 text-bolder text-white fadeIn1 fadeInBottom mt-5">Error 419</h1>
                        <h2 class="fadeIn3 fadeInBottom mt-3 text-white">Al parecer ya habías iniciado sesión anteriormente</h2>
                        {{-- <p class="lead fadeIn2 fadeInBottom text-white">We suggest you to go to the homepage while we solve
                            this issue.</p> --}}
                        <a href="/default" class="btn bg-gradient-dark mt-4 fadeIn2 fadeInBottom">Ir a inicio</a>
                    </div>
                </div>
            </div>
        </div>
