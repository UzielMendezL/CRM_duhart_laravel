...
@section('content')
    ...
    <div class="page-header position-relative" style="background-image: url('./assets/imgpricing-header-bg.jpg');
                ...
                <div class="col-lg-4 col-md-6 col-7 mx-auto text-center">
                    <div class="nav-wrapper mt-5 position-relative z-index-2">
                        <ul class="nav nav-pills nav-fill flex-row p-1" id="tabs-pricing" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link mb-0" id="tabs-iconpricing-tab-2" data-bs-toggle="tab" href="#annual"
                    ...
                    <div class="accordion-item mb-3">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                            ...
                            <div class="accordion-body text-sm opacity-8">
                                ...
                                sparked by it. And the people who are like offended by it, it doesn’t matter. Because
                                it&#39;s about motivating the doers. Because I’m here to follow my dreams and inspire other
                    ...
                    <div class="accordion-item mb-3">
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                            ...
                            <div class="accordion-body text-sm opacity-8">
                                ...
                                I&#39;m willing to fail is an inspiration. People are so scared to lose that they don&#39;t
                                even try. Like, one thing people can&#39;t say is that I&#39;m not trying, and I&#39;m not
